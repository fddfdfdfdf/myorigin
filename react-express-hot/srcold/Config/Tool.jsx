...
Tool.alert =  (msg,msg2) => {
    clearTimeout(timer);
    if (msg2) {
        alertText.innerHTML = '<div class="alert_contain"><div class="alert_detail"><div class="alert_bottom">'+msg+'</div><div class="alert_bottom">'+msg2+'</div></div></div>';
    }else{
        alertText.innerHTML = '<div class="alert_contain"><div class="alert_detail">'+msg+'</div></div>';
    }
